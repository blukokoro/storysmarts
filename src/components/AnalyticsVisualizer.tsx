...
const PieChartCard = ({
  ...
  title: string;
  description: string;
  data: typeof dummyGenreData;
}) => {
  return <Card className="glass-card overflow-hidden h-full">
  ...
  return <div className="py-20 relative w-full overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <PieChartCard title="Genre Composition" description="How your story blends different genres" data={dummyGenreData} />
          <PieChartCard title="Target Audience" description="Age demographics that would engage with your story" data={dummyAudienceData} />
          <PieChartCard title="Production Allocation" description="Recommended production resource distribution" data={dummyProductionData} />
        </div>
      </div>
    </div>;
};
