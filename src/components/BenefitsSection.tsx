...
const BenefitsSection: React.FC = () => {
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-blue-950/90 to-indigo-950/90" />
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute h-80 w-80 rounded-full bg-gradient-to-br from-purple-500/10 to-transparent blur-2xl top-40 -right-20 animate-float" style={{ animationDelay: '1s' }} />
        <div className="absolute h-72 w-72 rounded-full bg-gradient-to-br from-emerald-500/10 to-transparent blur-2xl bottom-20 left-1/4 animate-float" style={{ animationDelay: '2s' }} />
