            ...
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="text-primary font-bold text-xl flex items-center gap-2">
                <div className="relative w-7 h-7 flex items-center justify-center">
                  {/* Minimal logo with gradient circle and sparkle */}
                  <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-fuchsia-500 rounded-full opacity-90"></div>
                  <Sparkles className="relative w-3.5 h-3.5 text-white z-10" />
                </div>
