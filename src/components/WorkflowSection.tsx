      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between relative">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative z-10 flex flex-col items-center mb-10 md:mb-0 w-full max-w-[200px]">
              ...
              {index < steps.length - 1 && (
                <ArrowRight className="h-6 w-6 text-primary/60 mt-4 hidden md:block rotate-90 md:rotate-0" />
              )}
            </div>
          ))}
        </div>
